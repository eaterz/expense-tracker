...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-lg mx-auto">
        ...
        <form action="{{ route('expenses.update', $expense) }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    ...
                    <input type="number" name="amount" id="amount" step="0.01" min="0" value="{{ old('amount', $expense->amount) }}"
